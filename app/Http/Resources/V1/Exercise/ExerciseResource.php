...
class ExerciseResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        })->when(array_key_exists('question_answer_types_count', $this->resource->getAttributes()) && array_key_exists('question_answers_rahjoos_count', $this->resource->getAttributes()), function (Collection $collection) {
            $collection->put('is_answered_questions', $this->resource->question_answer_types_count == $this->resource->question_answers_rahjoos_count);
        });
    }
}
