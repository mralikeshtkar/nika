...
class UserResource extends JsonResource
{
    ...
    {
        return collect($this->resource)->when($this->resource->originalIsEquivalent('status') && UserStatus::hasValue(intval($this->resource->status)), function (Collection $collection) {
