...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    "enum_key" => ":attribute معتبر نمیباشد",
    "enum_value" => ":attribute معتبر نمیباشد",
    ...
    */
    'attributes' => [
        ...
        'computer_level' => "سطح کامپیوتر",
        'research_history' => "تاریخچه پژوهش",
        'work_description' => "توضیحات کار",
        'birth_certificate_number' => "شماره شناسنامه",
        'which_child_of_family' => "فرزند چندم خانواده",
        'school' => "مدرسه",
        'disease_background' => "سابقه بیماری",
