...
Route::prefix('v1')->group(function (Router $router) {
    ...
    $router->middleware('auth:sanctum')->group(function (Router $router) {
        ...
        $router->group([], function (Router $router) {
            ...
            $router->post('rahjoo-supports/{rahjooSupport}/information-completed', [V1ApiRahjooSupportController::class, 'informationCompleted']);
        ...
        $router->group([], function (Router $router) {
            ...
            $router->get('rahjoos/{rahjoo}/exercises/{exercise}/questions/{question}/is-completed', [V1ApiRahjooController::class, 'questionIsCompleted']);
